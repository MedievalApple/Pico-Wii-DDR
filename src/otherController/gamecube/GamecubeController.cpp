...
void GamecubeController::getSwitchReport(SwitchReport *switchReport) {
  ...
  switchReport->buttons[2] = 
      (GC_MASK_DPAD_UP & _controllerState[1] ? SWITCH_HAT_UP : 0) |
      (GC_MASK_DPAD_DOWN & _controllerState[1] ? SWITCH_HAT_DOWN : 0) |
      (GC_MASK_DPAD_LEFT & _controllerState[1] ? SWITCH_HAT_LEFT : 0) |
      (GC_MASK_DPAD_RIGHT & _controllerState[1] ? SWITCH_HAT_RIGHT : 0) ;
